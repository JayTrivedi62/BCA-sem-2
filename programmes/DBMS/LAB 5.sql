...
UPDATE DEPOSIT SET ACTNO=111 WHERE ACTNO=106;
UPDATE DEPOSIT SET AMOUNT=5000 WHERE AMOUNT=2000;
...
UPDATE BORROW SET AMOUNT=AMOUNT+1000;

--10. Update the customer’s name from MINU to SINU and change the amount to ₹10,000. 
UPDATE DEPOSIT SET CNAME='SINU',AMOUNT=10000 WHERE CNAME='MINU' AND AMOUNT=7000;
...
UPDATE BORROW SET AMOUNT=AMOUNT+AMOUNT*0.5 WHERE LOANNO<321;

--14. Update the customer city from BOMBAY to MUMBAI. 
UPDATE CUSTOMERS SET CITY='MUMBAI' WHERE CITY='BOMBAY';

--15. Update the branch name to VRCE where the Loan number is 375. 
UPDATE BORROW SET BNAME='VRCE' WHERE LOANNO=375;
...
UPDATE BORROW SET AMOUNT=6000 WHERE CNAME='SUNIL';

-- Change branch name of account number 110 to POWAI.
UPDATE DEPOSIT SET BNAME='POWAI' WHERE ACTNO=110; 

-- Update deposit amount to NULL where customer name is KRANTI.
UPDATE DEPOSIT SET AMOUNT=NULL WHERE CNAME='KRANTI';

-- Modify account number 108 to 208.
UPDATE DEPOSIT SET ACTNO=208 WHERE ACTNO=108;
...
UPDATE DEPOSIT SET AMOUNT=AMOUNT+500 WHERE AMOUNT<3000;

-- Update deposit amount to 8000 where branch name is POWAI.
UPDATE DEPOSIT SET AMOUNT=8000 WHERE BNAME='POWAI';

-- Change branch name to AJNI where account number is greater than 105.
UPDATE DEPOSIT SET BNAME='AJNI' WHERE ACTNO>105;

-- Update deposit date to 01-JAN-96 where branch name is VRCE.
UPDATE DEPOSIT SET ADATE='01-JAN-96' WHERE BNAME='VRCE';
...
UPDATE DEPOSIT SET BNAME='DHARAMPETH',AMOUNT=6500 WHERE ACTNO=109;

-- Change customer name MEHUL to MEHUL PATEL and amount to 4500.
UPDATE DEPOSIT SET CNAME='MEHUL PATEL',AMOUNT=4500 WHERE CNAME='MEHUL';

-- Modify branch name to NEHRU PLACE and deposit date to 15-AUG-95 where amount is 5000.
UPDATE DEPOSIT SET BNAME='NEHRU PLACE',ADATE='15-AUG-95' WHERE AMOUNT=5000;

-- Update amount = 9000 and branch name = VIRAR where customer name is MINU.
UPDATE DEPOSIT SET AMOUNT=9000,BNAME='VIRAR' WHERE CNAME='SINU';

-- Change account number to 999 and amount to 3000 where branch name is BANDRA.
UPDATE DEPOSIT SET ACTNO=999,AMOUNT=3000 WHERE BNAME='BANDRA';