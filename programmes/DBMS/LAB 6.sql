...
DELETE FROM DEPOSIT WHERE ADATE>'01-DEC-96';
...
DELETE FROM ACCOUNT WHERE AccountNo=203;

-- Delete all accounts whose Balance < 5000.
DELETE FROM ACCOUNT WHERE Balance<5000;

-- Delete account of customer KRANTI.
DELETE FROM ACCOUNT WHERE CustomerName='KRANTI';

-- Delete accounts opened before 01-JAN-2019.
DELETE FROM ACCOUNT WHERE OpenDate<'01-jan-2019';

-- Delete all CURRENT type accounts.
DELETE FROM ACCOUNT WHERE AccountType='CURRENT'

-- Delete transaction where TransactionID = 2.
DELETE FROM TRANSACTION_DETAILS WHERE TransactionID=2;

-- Delete all DEBIT transactions.
DELETE FROM TRANSACTION_DETAILS WHERE TransactionType='DEBIT';

-- Delete transactions where Amount > 4000.
DELETE FROM TRANSACTION_DETAILS WHERE AMOUNT>4000;

-- Delete transactions done before 01-FEB-2024.
DELETE FROM TRANSACTION_DETAILS WHERE TransactionDate<'01-FEB-2024';

-- Delete transactions of AccountNo = 201.
DELETE FROM TRANSACTION_DETAILS WHERE AccountNo=201;

-- Delete transactions of customers whose Balance < 6000.
DELETE FROM TRANSACTION_DETAILS WHERE Amount<6000;

-- Delete accounts whose AccountType is SAVING and Balance < 7000.
DELETE FROM ACCOUNT WHERE AccountType='SAVING' AND BALANCE<7000;

-- Delete transactions where customer name is SUNIL.
DELETE FROM ACCOUNT WHERE CustomerName='SUNIL';
