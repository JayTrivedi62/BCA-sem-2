...
ALTER TABLE EMPLOYEE ADD CITY VARCHAR(20) , STATE VARCHAR(20);
...
ALTER TABLE EMPLOYEE ALTER COLUMN JOINDATE DATE;

-- Change the datatype of Department from VARCHAR(20) to VARCHAR(30).
ALTER TABLE EMPLOYEE ALTER COLUMN DEPARTMENT VARCHAR(30);

-- Change the datatype of Email from VARCHAR(40) to VARCHAR(60).
ALTER TABLE EMPLOYEE ALTER COLUMN EMAIL VARCHAR(60);
